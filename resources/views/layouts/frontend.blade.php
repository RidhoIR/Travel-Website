...
<head>
    ...
    @stack('style-alt')
    <title>YukTraveling</title>
    <link rel="icon" href="{{asset('frontend/assets/img/logo2.png')}}" type="image/x-icon">
</head>
...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            ...
            <a target="_blank" href="" class="button nav__button">Booking Now</a>
        </nav>
    </header>
    ...
    <footer class="footer section">
        ...
        <div class="footer__info container">
            <span class="footer__copy">
                &#169; Trio Madagascar. All rigths reserved
            </span>
